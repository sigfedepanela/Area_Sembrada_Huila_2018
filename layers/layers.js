...
jsonSource_reaSembradaenCaaPaneleraHectareas_2.addFeatures(features_reaSembradaenCaaPaneleraHectareas_2);var lyr_reaSembradaenCaaPaneleraHectareas_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/reaSembradaenCaaPaneleraHectareas_2_0.png" />  5 - 97 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHectareas_2_1.png" />  97 - 217 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHectareas_2_2.png" />  217 - 420 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHectareas_2_3.png" />  420 - 1215 <br />\
    <img src="styles/legend/reaSembradaenCaaPaneleraHectareas_2_4.png" />  1215 - 3323 <br />'
        });
...
lyr_reaSembradaenCaaPaneleraHectareas_2.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', 'CULTIVO_1': 'CULTIVO_1', 'AÑO': 'AÑO', 'A.SEM.(Ha)': 'A.SEM.(Ha)', 'A.COS.(Ha)': 'A.COS.(Ha)', 'PROD.(Ton)': 'PROD.(Ton)', 'REND.(Ton/': 'REND.(Ton/', });
...
lyr_reaSembradaenCaaPaneleraHectareas_2.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', 'CULTIVO_1': 'TextEdit', 'AÑO': 'TextEdit', 'A.SEM.(Ha)': 'TextEdit', 'A.COS.(Ha)': 'TextEdit', 'PROD.(Ton)': 'TextEdit', 'REND.(Ton/': 'TextEdit', });
...
lyr_reaSembradaenCaaPaneleraHectareas_2.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', 'CULTIVO_1': 'inline label', 'AÑO': 'inline label', 'A.SEM.(Ha)': 'inline label', 'A.COS.(Ha)': 'inline label', 'PROD.(Ton)': 'inline label', 'REND.(Ton/': 'inline label', });
